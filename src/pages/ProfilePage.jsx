...
const COLORS = {
  // NOTE: legacy map kept for structure; values now map to CSS vars
  ...
  subtext2: "color-mix(in srgb, var(--text) 48%, transparent)",
  red: "var(--accent)",
  redSoft: "color-mix(in srgb, var(--accent) 18%, transparent)",
  green: "rgb(34,197,94)",
